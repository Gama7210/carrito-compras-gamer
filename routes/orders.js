...
router.get('/:id/ticket', requireAuth, async (req, res) => {
    try {
        ...
        doc.fontSize(20).font('Helvetica-Bold').text('GameTech - Ticket de Compra', { align: 'center' });
        doc.moveDown();
        ...
        doc.text('GameTech - Tu tienda gamer de confianza', { align: 'center' });
        doc.text('www.gametech.com | contacto@gametech.com', { align: 'center' });
